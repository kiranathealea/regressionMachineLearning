...
for i in range (19):
    ...
    # export_csv = df.to_csv(r'/home/leathea/Downloads/Machine-Learning/PolynomialRegression/hasilmaize/'+daftar_kota[i]+r'_maize.csv', index = None, header=True) 
    export_csv = df.to_csv(r'/home/leathea/Downloads/Machine-Learning/PolynomialRegression/hasiltomato/linear/'+daftar_kota[i]+r'_tomato.csv', index = None, header=True)
    # #plot grafik
    ...
    #export to csv
    # combined_csv.to_csv( "/home/leathea/Downloads/Machine-Learning/PolynomialRegression/predicted_maize.csv", index=False, encoding='utf-8-sig')
