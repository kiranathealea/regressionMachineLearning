...
for i in range (19):
    ...
    # export_csv = df.to_csv(r'/home/leathea/Downloads/Machine-Learning/PolynomialRegression/hasilmaize/poly/'+daftar_kota[i]+r'_maize.csv', index = None, header=True)
    export_csv = df.to_csv(r'/home/leathea/Downloads/Machine-Learning/PolynomialRegression/hasiltomato/poly/'+daftar_kota[i]+r'_tomato.csv', index = None, header=True) 
    ...
    # os.chdir("/home/leathea/Downloads/Machine-Learning/PolynomialRegression/hasilmaize/poly")
    ...
    #export to csv
    # combined_csv.to_csv( "/home/leathea/Downloads/Machine-Learning/PolynomialRegression/predicted_poly_maize.csv", index=False, encoding='utf-8-sig')
